...
public class CoffeShop {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < beverage.length; i++) {
			...
			switch(menu) {
			case 1: 
				beverage[i] = new Coffee("Americano");
				System.out.println("Americano"); 
				break;
			case 2: 
				beverage[i] = new Coffee("CafeLatte");
				System.out.println("CafeLatte"); 
				break;
			case 3: 
				beverage[i] = new Coffee("Cappuccino");
				System.out.println("Cappuccino"); 
				break;
			case 4: 
				beverage[i] = new Tea("lemonTea");
				System.out.println("lemonTea"); 
				break;
			case 5: 
				beverage[i] = new Tea("ginsengTea");
				System.out.println("ginsengTea"); 
				break;
			case 6: 
				beverage[i] = new Tea("redginsengTea");
				System.out.println("redginsengTea"); 
				break;					
			default: 
